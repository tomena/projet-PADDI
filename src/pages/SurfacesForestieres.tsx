...
const evolution = [
  { annee: '2025', valeur: 6250 },
  { annee: '2026', valeur: 12850 },
  { annee: '2027', valeur: 19420 },
  { annee: '2028', valeur: 27360 },
  { annee: '2029', valeur: 34145 },
  { annee: '2030', valeur: 42385 },
];

const regions = [
  { name: 'Boeny', value: 12450 },
  { name: 'DIANA', value: 10280 },
  { name: 'Amoron’i Mania', value: 7680 },
  { name: 'Vakinankaratra', value: 6840 },
  { name: 'Anôsy', value: 3925 },
  { name: 'Atsimo Atsinanana', value: 1210 },
];

const typeTerrain = [
  { name: 'Bois énergie', value: 15280, color: '#66bb6a', pct: '36,0%' },
  { name: 'Restauration forêt', value: 11200, color: '#D4E157', pct: '26,4%' },
  { name: 'Restauration sources', value: 6480, color: '#64B5F6', pct: '15,3%' },
  { name: 'RNA', value: 5430, color: '#2e7d32', pct: '12,8%' },
  { name: 'Stabilisation lavaka', value: 4995, color: '#FFB300', pct: '11,8%' },
];

const typePratique = [
  { name: 'Restauration des paysages', value: 13620, color: '#2e7d32', pct: '32,1%' },
  { name: 'Production durable', value: 11430, color: '#66bb6a', pct: '27,0%' },
  { name: 'Gestion durable des ressources naturelles', value: 11025, color: '#a5d6a7', pct: '26,0%' },
  { name: 'Valorisation des productions durables', value: 6310, color: '#FFB300', pct: '14,9%' },
];
...
<div style={{ background: '#f4f6f5', minHeight: '100vh', fontFamily: 'Arial' }}>
  ...
  <h2 style={{ margin: 0 }}>
  🌳 Suivi des surfaces forestières
  </h2>
...
>
  <h4
    ...
    >Énoncé de l’indicateur
      ...
      >
      Les surfaces sur lesquelles des pratiques forestière durables sont appliquées augmentent de 70.000 hectares dans les Communes partenaires.
      </div>
  </div>
    ...
    {/* Ligne supérieure */}
      ...
      <div style={chartCardStyle}>
          <h4 style={{
            ...
            Répartition de la surface forestière par région (ha)
          </h4>
      ...
      <div style={chartCardStyle}>
            ...
            Répartition de la surface par type de terrain (ha)
          </h4>
      ...
      <div style={chartCardStyle}>
            <h4 style={{
              ...
              Répartition de la surface par type de pratique (ha)
            </h4>
